...
export DATABASE=maindb

export PG_MASTER_PASSWORD=7FuJ5c1CEueQI81X5RED
export PG_PRIMARY_USER=motu
export PG_USER=admin
export PG_PASSWORD=7FuJ5c1CEueQI81X5RED
export PG_ROOT_PASSWORD=7FuJ5c1CEueQI81X5RED
